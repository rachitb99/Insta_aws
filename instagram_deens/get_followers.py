...
options.add_extension("/Users/rachitbansal/Downloads/instagram_deens/extension.crx")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/rachitbansal/Downloads/{}_followers.csv /Users/rachitbansal/Downloads/instagram_deens/accounts'.format(account))
        except:
